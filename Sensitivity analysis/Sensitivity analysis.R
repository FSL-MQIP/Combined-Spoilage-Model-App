...
# SA_result_Medium_Plant_D21$var = c("t_F","T_F","t_T","T_T","t_S","T_S","t_T2","T_T2","T_H","N0")
...
# SA_result_Bad_Plant_D21$var = c("t_F","T_F","t_T","T_T","t_S","T_S","t_T2","T_T2","T_H","N0")
...
# SA_result_Medium_Plant_D21$var = c("Processing facility storage time", 
                                 # "Processing facility storage temperature",
                                 # "Transportation time between processing facility and retail",
                                 # "Transportation temperature between processing facility and retail", 
                                 # "Retail storage time",
                                 ...
                                 # "Consumer home storage temperature",
                                 # "Initial contamination level")
# SA_result_Medium_Plant_D21$asterisk <- ifelse(SA_result_Medium_Plant_D21$p.value < 0.005, "*", "")
# SA_result_Medium_Plant_D21 <- SA_result_Medium_Plant_D21[order(-abs(SA_result_Medium_Plant_D21$abs_PRCC_value)), ]
...
# SA_result_Bad_Plant_D21$var = c("Processing facility storage time", 
                               # "Processing facility storage temperature",
                               # "Transportation time between processing facility and retail",
                               # "Transportation temperature between processing facility and retail", 
                               # "Retail storage time",
                               ...
                               # "Consumer home storage temperature",
                               # "Initial contamination level")
# SA_result_Bad_Plant_D21$asterisk <- ifelse(SA_result_Bad_Plant_D21$p.value < 0.005, "*", "")
# SA_result_Bad_Plant_D21 <- SA_result_Bad_Plant_D21[order(-abs(SA_result_Bad_Plant_D21$abs_PRCC_value)), ]
...
# SA_result_Medium_Plant_D21$var <- fct_reorder(SA_result_Medium_Plant_D21$var, abs(SA_result_Medium_Plant_D21$abs_PRCC_value))
# plot_Medium <- ggplot(SA_result_Medium_Plant_D21, aes(x = est, y = var)) +
  # geom_bar(stat = "identity", fill = "grey") +
  # geom_text(aes(label = asterisk, 
                # hjust = ifelse(est < 0, 1.2, -0.2)), # Adjust hjust based on positive or negative PRCC
            # size = 5) +   # Adjust the size of the asterisk
...
# SA_result_Bad_Plant_D21$var <- fct_reorder(SA_result_Bad_Plant_D21$var, abs(SA_result_Bad_Plant_D21$abs_PRCC_value))
# plot_Bad <- ggplot(SA_result_Bad_Plant_D21, aes(x = est, y = var)) +
  # geom_bar(stat = "identity", fill = "grey") +
  # geom_text(aes(label = asterisk, 
                # hjust = ifelse(est < 0, 1.2, -0.2)), # Adjust hjust based on positive or negative PRCC
            # size = 5) +   # Adjust the size of the asterisk

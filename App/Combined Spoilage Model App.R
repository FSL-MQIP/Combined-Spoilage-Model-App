...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      checkboxInput("mf","Microfiltration (2.2 log reduction)", value=FALSE),
      checkboxInput("bf1","Bactofugation single-pass (1.4 log reduction)", value=FALSE),
      checkboxInput("bf2","Bactofugation double-pass (2 log reduction)", value=FALSE),
      h5(strong("Select PPC reduction technology")),
      checkboxInput("mt1","Improved preventive maintenance (1 log reduction)", value=FALSE),
      checkboxInput("mt2","Improved preventive maintenance (3 log reduction)", value=FALSE),
